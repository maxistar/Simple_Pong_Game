...
- Players score 5 points for each successful bounce.
- Score is displayed in the center of the canvas.
...
1. **Clone the repository**:
   ```bash
   git clone hhttps://github.com/Make-Europe/Simple_Pong_Game.git
   cd your-repository
